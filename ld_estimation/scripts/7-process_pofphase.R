#!/usr/bin/env Rscript
#PBS -N 7-process_pofphase
#PBS -l nodes=1:ppn=1,walltime=08:00:00,mem=200Gb
#PBS -j oe
#PBS -o ../output/7-process_pofphase
#PBS -m abe
#PBS -t 1-6
#PBS -M funkhou9@msu.edu

#' # Script: 7-process_pofphase.R
#'
...
#' using a few binning strategies. Similar to `3-process_ld_1kb.R`, persistance
#' of phase will be estimated using 1KB windows from 0 to 50KB.
#'
...
obj <- paste0(paste(ith_pair, collapse = "_"), "_1kb")
assign(obj,
       lapply(groups,
              function(x) {
